...
//     const [editedAddress, setEditedAddress] = useState<prismaTypes.Address>();
    
//     const orderId = orderQuery.data?.data?.id;

//     const returnReplacementDetails = trpc.viewer.orders.getOrderReturnDetails.useQuery(
//       { orderId: orderId || "" },
//       { 
//         enabled: !!orderId && !!order?._count.return,
//         // Only fetch if we have an order ID and there are returns
//       }
//     );
