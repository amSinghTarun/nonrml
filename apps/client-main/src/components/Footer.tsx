export const Footer = () => {
    return (
        <div className="bottom-0 h-fit flex-col w-full text-xs fixed -z-50 border-t border-neutral-700 bg-black/45 text-neutral-800 flex">
            ...
            <div className="flex flex-1 flex-row p-3 justify-around w-full border-t-2 border-neutral-800 text-neutral-800 font-light">
