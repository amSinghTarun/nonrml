export const Footer = () => {
    return (
        <div className="bottom-0 h-fit flex-col lg:flex-row w-full gap-3 text-xs justify-around relative px-10 py-10 border-t border-black bg-white text-black flex">
