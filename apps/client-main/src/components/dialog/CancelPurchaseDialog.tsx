...
const CanclePurchaseDialog = () => {
    ...
    return (
        <AlertDialog>
            <AlertDialogTrigger className="fixed cursor-pointer rounded-full font-bold p-1 text-xs -right-3 -top-3">
            ...
            <AlertDialogContent className="bg-white/60 border-0 rounded-xl">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="font-lg font-bold pb-3 text-black">
