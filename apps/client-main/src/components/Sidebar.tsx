  ...
  return (
    <>
      ...
      <nav className="fixed flex flex-col w-screen max-h-screen justify-end items-center z-40 h-full">
        ...
        <aside className="backdrop-blur-2xl bg-white/10 flex flex-col shadow-sm shadow-neutral-500 h-[60%] w-[90%] lg:w-[50%] lg:h-[70%] justify-between rounded-t-md pb-5 overflow-hidden translate-y-full animate-[slideUp_0.4s_cubic-bezier(0.16,1,0.3,1)_forwards]">
          {/* Navigation content - scrollable if needed */}
          <div color="white" className="flex-1 p-3 px-3 overflow-y-auto">
            <div className="flex-col h-full flex divide-black font-bold text-xs tracking-[0.25em]">
          ...
          <footer className="flex flex-col text-[10px] tracking-[0.15em] text-center space-y-2 divide-y divide-dotted divide-black px-2 flex-shrink-0">
            <div className="flex flex-row divide-x divide-dotted divide-black py-1 font-bold justify-evenly">
              <Link className="text-black flex-1 justify-center cursor-pointer hover:underline py-2" href="/orders">
                ORDERS
              </Link>
              <Link className="text-black flex-1 justify-center hover:underline py-2" href="/creditNote">
                CREDIT NOTES
              </Link>
              <Link className="text-black flex-1 justify-center cursor-pointer hover:underline py-2" href="/track-order">
                TRACK ORDER
              </Link>
            </div>
            <span className="flex text-[9px] tracking-[0.1em] pt-2 text-black justify-center">
