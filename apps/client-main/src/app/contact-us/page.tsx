...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with NoNRML for product information, order queries, customer support, or general inquiries. We\'re here to help with your streetwear shopping experience. Email us at info@nonrml.com',
  ...
  openGraph: {
    ...
    url: 'https://www.nonrml.com/contact-us',
    type: 'website',
    locale: 'en_IN',
    siteName: 'NoNRML',
  },
  ...
  alternates: {
    canonical: 'https://www.nonrml.com/contact-us',
  },
}
...
const ContactUsPage = () => {
    ...
    return (
        <section className=" flex h-screen w-screen flex-row text-black justify-center items-center bg-white mb-[335px] lg:mb-[235px]">
