...
const ExchangeOrders = async ({params}: {params: Promise<{orderId: string}>}) => {
    ...
    return (
        <section className="pt-14 pb-5 z-30 flex-col min-h-screen h-auto w-screen overflow-scroll flex bg-white mb-[500px] lg:mb-[220px]">
            <Exchanges exchangeOrders={userExchanges.data.replacementOrder} refund={userExchanges.data.bankRefunds}/> 
        </section>
    )
}
