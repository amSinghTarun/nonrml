...
const OrdersPage = async ({params, searchParams}: {params: Promise<{orderId: string}>,  searchParams: Promise<{ [key: string]: string | string[] | undefined }>}) => {
    ...
    return (
        <section className="pt-14 pb-5 z-30 flex-col min-h-screen h-auto w-screen overflow-y-scroll overscroll-y flex bg-white mb-[335px] lg:mb-[235px] scrollbar-hide">
