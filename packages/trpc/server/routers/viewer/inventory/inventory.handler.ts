import { Prisma, prisma, prismaTypes } from "@nonorml/prisma";
import { TAddInventoryItemSchema, TEditInventoryItemSchema, TDeleteInventoryItemSchema, TGetInventoryItemSchema, TGetSKUDetailsSchema, TGetInventoryItemsSchema } from "./inventory.schema";
...
*/
export const addInventoryItem = async ({ctx, input}: TRPCRequestOptions<TAddInventoryItemSchema>)  => {
    try{        
