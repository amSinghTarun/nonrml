...
import { TChangePassword, TInitiateChangePasswordRequest, TSigninSchema, TSignupSchema, TVerifyChangePasswordOTP } from "./sign.schema";
import { createPasswordHash, TRPCRequestOptions, verifyPassword } from "../helper";
...
const createOTP = (len: number) : number => (Math.random() * len * 100000).toFixed() as unknown as number
