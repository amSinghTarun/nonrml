                ...
                <tr>
                    <td style="padding: 40px 30px 30px;">
                        ...
                        <div style="margin: 25px 0;">
                            <a href="www.nonrml.com" style="color: #000000; text-decoration: none; font-size: 12px; font-weight: 500;">Visit our store</a>
                        </div>
                    </td>
                </tr>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-collapse: collapse; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
                ...
                <tr>
                    <td style="padding: 40px 30px 30px;">
                        ...
                        <!-- View Order Button -->
                        <div style="margin: 25px 0;">
                            <a href="www.nonrml.com/orders/${escapeHtml(orderId)}" style="display: inline-block; padding: 12px 24px; background-color: #000000; color: #ffffff; text-decoration: none; font-size: 12px; font-weight: 600; border-radius: 6px; font-family: 'Inter', 'Helvetica Neue', Arial, sans-serif; transition: background-color 0.2s;">View your order</a>
