            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 500px; margin: 0 auto; background-color: #ffffff; border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: ${hasCreditNote ? '0' : '20px'} 40px 60px; text-align: center;">
                        <a href="https://www.nonrml.com/orders/ORD-${escapeHtml(data.orderId)}${escapeHtml(data.orderIdVarChar)}" style="display: inline-block; padding: 10px 24px; background-color: #000000; color: #ffffff; text-decoration: none; font-size: 11px; font-weight: 400; text-transform: uppercase; letter-spacing: 0.1em; border: none; margin-right: 10px;">View Order</a>
                        <a href="https://www.nonrml.com" style="display: inline-block; padding: 10px 24px; background-color: #ffffff; color: #000000; text-decoration: none; font-size: 11px; font-weight: 400; text-transform: uppercase; letter-spacing: 0.1em; border: 1px solid #000000;">Continue Shopping</a>
                    </td>
                </tr>
